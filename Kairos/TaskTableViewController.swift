...
class TaskTableViewController: UITableViewController, IndicatorInfoProvider  {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "TaskTableViewCell", bundle: Bundle.main), forCellReuseIdentifier: "taskCell")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let count = task.users?.count, count > 0 {
            cell.assigneesLabel.text = String(count)
        } else {
            cell.assigneesLabel.text = "Unassigned"
        }
        cell.dueDateLabel.text = String.mediumDateNoTime(task.dateEnd! as Date)
...
extension TaskTableViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    func title(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        return NSAttributedString(string: "No Tasks")
    }
}
